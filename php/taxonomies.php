...
/**
 * Remove default taxonomy boxes because they are added by the custom meta box
 */
add_action( 'admin_menu' , 'recipress_remove_taxonomy_boxes' );
function recipress_remove_taxonomy_boxes() {
	remove_meta_box( 'tagsdiv-ingredient', recipress_options( 'post_type' ), 'side' );
	remove_meta_box( 'tagsdiv-cuisine', recipress_options( 'post_type' ), 'side' );
	remove_meta_box( 'tagsdiv-course', recipress_options( 'post_type' ), 'side' );
	remove_meta_box( 'tagsdiv-skill_level', recipress_options( 'post_type' ), 'side' );
}